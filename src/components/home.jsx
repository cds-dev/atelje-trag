	...
	render() {
		...
		return ( 
			<div className="main">
				...
				<Link to={process.env.PUBLIC_URL + '/people'}><div className="fp_button sect sect_peop">{lang[language][0]}</div></Link>
				<Link to={process.env.PUBLIC_URL + '/machines'}><div className="fp_button sect sect_mach">{lang[language][1]}</div></Link>
			</div> )
	}
}
export default Home;